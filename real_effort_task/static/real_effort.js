...
let fields = {
    ...
    earning: document.getElementById('earning-txt'),
    ...
    switch(message.type) {
        ...
        case 'status':
            if (message.puzzle) { // restoring existing state
                ...
                let answer_box = document.getElementById("answer-inp");
                let max_message = document.createElement("p");
                max_message.innerHTML = "<b>You have done 10 tables. Please click the button below continue to the next stage.</b>";
                answer_box.parentNode.replaceChild(max_message, answer_box);
            }
            break;
...
function showProgress(data) {
    ...
    fields.earning.textContent = data.earning
